                ...
                case 1:
                    ...
                    if (accessTokenRequest && accessTokenRequest.scopes) {
                        ...
                        if (!array_1.match(accessTokenRequest.scopes, tslib_1.__spread(matchingScopes))) {
                            throw new errors_1.AccessTokenError(errors_1.AccessTokenErrorCode.INSUFFICIENT_SCOPE, "Could not retrieve an access token with scopes \"" + accessTokenRequest.scopes.join(' ') + "\". The user will need to sign in again.");
                        }
                    }
