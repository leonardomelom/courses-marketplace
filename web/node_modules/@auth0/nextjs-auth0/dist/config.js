...
var getConfig = function (params) {
    ...
    var nextConfig = {
        routes: tslib_1.__assign(tslib_1.__assign({}, baseConfig.routes), { login: ((_d = baseParams.routes) === null || _d === void 0 ? void 0 : _d.login) || exports.getLoginUrl(), unauthorized: ((_e = baseParams.routes) === null || _e === void 0 ? void 0 : _e.unauthorized) || '/api/auth/401' }),
