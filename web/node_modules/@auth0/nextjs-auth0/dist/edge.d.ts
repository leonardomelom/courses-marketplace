...
export declare type Auth0Edge = {
    withMiddlewareAuthRequired: WithMiddlewareAuthRequired;
    getSession: GetSession;
};
export declare type GetSession = (req: NextRequest, res: NextResponse) => Promise<Session | null | undefined>;
export declare type InitAuth0 = (params?: ConfigParameters) => Auth0Edge;
