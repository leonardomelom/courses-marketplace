...
var encryption = function (secret) {
    return hkdf_1.default(digest, secret, '', ENCRYPTION_INFO, BYTE_LENGTH);
};
exports.encryption = encryption;
var signing = function (secret) { return hkdf_1.default(digest, secret, '', SIGNING_INFO, BYTE_LENGTH); };
