...
var Cookies = /** @class */ (function () {
    ...
    Cookies.prototype.set = function (name, value, options) {
        ...
        this.cookies.push(cookie_1.serialize(name, value, options));
    };
    ...
    Cookies.prototype.commit = function (res, filterCookiePrefix) {
        ...
        if (filterCookiePrefix) {
            var re_1 = new RegExp("^" + filterCookiePrefix + "(\\.\\d+)?=");
            previousCookies = previousCookies.filter(function (cookie) { return !re_1.test(cookie); });
        }
        this.setSetCookieHeader(res, tslib_1.__spread(previousCookies, this.cookies));
    };
    return Cookies;
}());
