 ...
 * @category Server
 */
export declare type ProfileOptionsProvider = (req: NextApiRequest) => ProfileOptions;
/**
 ...
 * @category Server
 */
export declare type HandleProfile = {
 ...
 * @category Server
 */
export declare type ProfileHandler = (req: NextApiRequest, res: NextApiResponse, options?: ProfileOptions) => Promise<void>;
/**
 * @ignore
 */
