 ...
 * @category Server
 */
export declare type CallbackOptionsProvider = (req: NextApiRequest) => CallbackOptions;
/**
 ...
 * @category Server
 */
export declare type HandleCallback = {
 ...
 * @category Server
 */
export declare type CallbackHandler = (req: NextApiRequest, res: NextApiResponse, options?: CallbackOptions) => Promise<void>;
/**
 * @ignore
 */
