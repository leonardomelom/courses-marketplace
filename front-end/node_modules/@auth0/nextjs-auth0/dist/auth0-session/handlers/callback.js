            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!callbackParams.state) {
                        throw http_errors_1.default(404, new errors_1.MissingStateParamError());
                    }
                    return [4 /*yield*/, transientCookieHandler.read('state', req, res)];
                case 2:
                    expectedState = _a.sent();
                    if (!expectedState) {
                        throw http_errors_1.default(400, new errors_1.MissingStateCookieError());
                    }
                ...
                case 9:
                    ...
                    throw http_errors_1.default(400, err_1, { openIdState: encoding_1.decodeState(expectedState) });
                case 10:
                    openidState = encoding_1.decodeState(expectedState);
