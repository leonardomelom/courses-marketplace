    ...
    return function withMiddlewareAuthRequired(middleware) {
        return function wrappedMiddleware() {
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _c, req, _d, pathname, origin, ignorePaths, sessionCache, authRes, session, res, headers, cookies, authCookies;
                return tslib_1.__generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _c = tslib_1.__read(args, 1), req = _c[0];
                            _d = req.nextUrl, pathname = _d.pathname, origin = _d.origin;
                        ...
                        case 1:
                            ...
                            if (!(session === null || session === void 0 ? void 0 : session.user)) {
                                ...
                                return [2 /*return*/, server_1.NextResponse.redirect(new URL(login + "?returnTo=" + encodeURIComponent(req.nextUrl.toString()), origin))];
                            }
                            return [4 /*yield*/, (middleware && middleware.apply(void 0, tslib_1.__spread(args)))];
                        case 2:
                            res = _e.sent();
                            if (res) {
                                ...
                                if (cookies.length || authCookies.length) {
                                    headers.set('set-cookie', tslib_1.__spread(authCookies, cookies).join(', '));
                                }
