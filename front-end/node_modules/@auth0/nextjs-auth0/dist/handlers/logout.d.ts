 ...
 * @category Server
 */
export declare type LogoutOptionsProvider = (req: NextApiRequest) => LogoutOptions;
/**
 ...
 * @category Server
 */
export declare type LogoutHandler = (req: NextApiRequest, res: NextApiResponse, options?: LogoutOptions) => Promise<void>;
/**
 * @ignore
 */
