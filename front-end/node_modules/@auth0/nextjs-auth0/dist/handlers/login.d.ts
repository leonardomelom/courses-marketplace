 ...
 * @category Server
 */
export declare type LoginOptionsProvider = (req: NextApiRequest) => LoginOptions;
/**
 ...
 * @category Server
 */
export declare type HandleLogin = {
 ...
 * @category Server
 */
export declare type LoginHandler = (req: NextApiRequest, res: NextApiResponse, options?: LoginOptions) => Promise<void>;
/**
 * @ignore
 */
