 ...
 * @category Server
 */
export declare type Handlers = ApiHandlers | ErrorHandlers;
declare type ApiHandlers = {
 ...
 * @category Server
 */
export declare type HandleAuth = (userHandlers?: Handlers) => NextApiHandler;
/**
 ...
 * @category Server
 */
export declare type OnError = (req: NextApiRequest, res: NextApiResponse, error: HandlerError) => Promise<void> | void;
/**
 * @ignore
 */
